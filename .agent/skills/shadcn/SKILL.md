---
name: shadcn
description: ALWAYS use this when adding, customizing, debugging, or composing shadcn/ui components, registries, themes, or CLI-driven design-system setup in a project.
---
...
Then read `cli.md`, `customization.md`, `mcp.md`, or the relevant `rules/` file for the exact task.
...
See [cli.md — `info` command](references/legacy-cli.md) for the full field reference.
...
- [cli.md](references/legacy-cli.md) — Commands, flags, presets, templates
- [customization.md](references/legacy-customization.md) — Theming, CSS variables, extending components
