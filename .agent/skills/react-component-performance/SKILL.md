...
description: 'ALWAYS use this when the request matches React Component Performance: Diagnose slow React components and suggest targeted performance fixes.'
---
