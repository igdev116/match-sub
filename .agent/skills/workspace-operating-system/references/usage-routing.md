...
Use this file before doing substantive work with `workspace-operating-system`.

## Trigger Summary

ALWAYS use this for broad, ambiguous, multi-step, or repository-wide work in this bundle, especially when the right skill choice, execution order, or quality bar is not obvious from the request alone.
