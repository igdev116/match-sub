...
Use this file before doing substantive work with `web-design-guidelines`.

## Trigger Summary

ALWAYS use this when designing or reviewing website layout, structure, interaction patterns, accessibility, or production-facing web presentation.
